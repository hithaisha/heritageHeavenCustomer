                  ...
                  <Col lg="6">
                    <div className="subscribe">
                      <div>
                        ...
                        <p>
                          Never Miss Anything From HeritageHeaven By Signing Up To Our
                          Newsletter.
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    <div className="footer-contant">
                      <ul className="contact-list">
                        <li>
                          <i className="fa fa-map-marker"></i>Heritage Heaven, Sri Lanka
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          <a href="#">heritageheaven@gmail.com</a>
                        </li>
                        <li>
